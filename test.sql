...
CREATE TABLE IF NOT EXISTS `mobility`.`person` (
  ...
  `ort_id` INT NOT NULL,
  `abonnament_id` INT NULL,
  `rechnung_id` INT NULL,
  `verantwortlicher_haushalt` TINYINT NOT NULL,
  PRIMARY KEY (`id`, `ort_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
...
-- Here come all inserts
INSERT INTO `ort`(`plz`, `stadt`) VALUES ('8134','Adlswil'), ('8038', 'Wollishofen');
INSERT INTO `tarif`(`preis_pro_stunde_nacht`, `preis_pro_stunde_tag`, `kilomoter_unter_100`, `kilometer_ueber_100`) 
VALUES ('2.70CHF','0.60CHF','0.50CHF','0.25CHF'), ('2.70CHF','0.60CHF','0.54CHF','0.27CHF'), ('2.70CHF','0.60CHF','0.60CHF','0.30CHF');
INSERT INTO `auto`(`name`, `model`, `anz_personen`, `anz_koffer`, `tarif_id`, `manual`) VALUES 
('M-Budget','Fiat Panda','5','2', 1, 'm'), ('Micro','Smart passion','2','1', 2, 'a'), ('Economy','Suzuki Swift','5','3', 3, 'b');   
...
INSERT INTO `rechnung`(`preis`, `datum`, `anrede`, `beschreibung`)
VALUES('50CHF', DATE '2022-05-17', 'Alex Smolders', 'Auto ausgeliehen in Zürich von A bis B'),
('190CHF', DATE '2022-05-17', 'Severin Machaz', 'Zahlung des Abos');
INSERT INTO `ermahnung`(`datum`, `rechnung_id`) VALUES (DATE '2022-05-24',2), (DATE '2022-06-3',2);